...
import RootButton from "../components/layout/Button/rootButton";
                ...
                <div className={"col-span-1 grid grid-cols-2"}>
                    <div className={"h-full col-span-1 grid grid-rows-20"}>
                        {[...Array(repeatCount_l)].map((_, index) => (
                            <div key={index} className={"border-r-[15px] border-yellow-300 mt-[20px] mr-[10px]"}></div>
                        ))}
                        <div className={"row-span-12 border-r-[15px] border-yellow-300 mr-[10px]"}/>
                    </div>
                    <div className={"h-full col-span-1 grid grid-rows-20"}>
                        <div className={"row-span-12 border-l-[15px] border-yellow-300 mr-[10px]"}/>
                        {[...Array(repeatCount_r)].map((_, index) => (
                            <div key={index} className={"border-l-[15px] border-yellow-300 mt-[20px] mr-[10px]"}></div>
                        ))}
                    </div>
                </div>
