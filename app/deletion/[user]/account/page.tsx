            ...
            <div
                ...
                <div className={"row-span-2"}>
                    <p>계정 삭제 시 본인의 게시글, 계정 관련 모든 정보(이메일 등) 는(은) 영구히 삭제되며 요청이 전송될 시 이를 무효화 할 수 없습니다. 요청을 보내기 전 다시 한번
                        숙고하십시요.</p>
                    <div className={"my-2"}>
                        <p className={"inline"}>삭제 대상 계정의 사용자 이름 : </p><p className={"inline text-blue-200"}>{params.user}</p>
                    </div>
                </div>
                <div className={"row-start-7"}>
                    <div>
                        <form>
                            <InputElement placeholder={undefined} type={"submit"} custom={"w-full border-2 border-white rounded"} value={"눌러서 계정 삭제 요청 전송"}/>
                        </form>
                    </div>
                </div>
            </div>
